...
CREATE TABLE tt_content (
	gdpr_pinterest_profile_url varchar(255) NOT NULL DEFAULT '',
	scale_profile_height int(11) NOT NULL DEFAULT '0',
	board_profile_width int(11) NOT NULL DEFAULT '0',
	scale_profile_width int(11) NOT NULL DEFAULT '0',
);
