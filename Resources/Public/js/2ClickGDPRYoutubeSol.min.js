...
var _2ClickIframePrivacy = new function() {
  ...
  this.types = new Array(
    {
      type: 'pin',
      description: 'Zum Aktivieren des Pins bitte auf den Link klicken. Durch das Aktivieren von eingebetteten Pins werden Daten an den jeweiligen Anbieter übermittelt. Weitere Informationen können unserer Datenschutzerklärung entnommen werden.<br />'
    },
    {
      type: 'map',
